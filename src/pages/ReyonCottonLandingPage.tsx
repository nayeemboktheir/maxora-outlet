...
const PRODUCT_SLUGS = [
  'new-digital-tarsel-black-color-copy-1771362462422-copy-1771362667456', // Reyon Cotton Onion color
  'new-digital-tarsel-black-color-copy-1771362462422',                    // Reyon Cotton cream color
];

// Color labels
const COLOR_LABEL: Record<string, string> = {
  'new-digital-tarsel-black-color-copy-1771362462422-copy-1771362667456': 'অনিয়ন কালার',
  'new-digital-tarsel-black-color-copy-1771362462422': 'ক্রিম কালার',
};

// Color dot style
const COLOR_DOT: Record<string, string> = {
  'new-digital-tarsel-black-color-copy-1771362462422-copy-1771362667456': 'bg-purple-300 border-purple-400',
  'new-digital-tarsel-black-color-copy-1771362462422': 'bg-amber-100 border-amber-300',
};
...
const UrgencyBanner = memo(() => {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-600 via-violet-600 to-purple-600 text-white py-3 px-4">
...
const HeroSection = memo(({ products, onBuyNow, selectedProductId, onProductSelect }: {
  ...
  return (
    <section className="relative py-4 sm:py-6 md:py-10 overflow-hidden bg-gradient-to-br from-purple-50 via-violet-50 to-amber-50">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-40 h-40 bg-purple-200/30 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-10 w-60 h-60 bg-amber-200/30 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
          ...
          <div className="lg:order-1">
            ...
            <div className="text-center lg:hidden mb-4">
              <motion.div
                ...
                className="mb-3"
              >
                <span className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-violet-600 text-white px-6 py-2.5 rounded-full text-base font-bold shadow-lg">
              ...
              <p className="text-gray-600 text-base sm:text-lg">
                ১০০% রেয়ন কটন, এমব্রয়ডারি ও সিকোয়েন্স ওয়ার্ক
              </p>
            </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl bg-white ring-4 ring-purple-100 max-w-md mx-auto">
            ...
            <div className="text-center mt-6 lg:hidden">
              <div className="flex items-center justify-center gap-3 flex-wrap">
                ...
                <span className="text-purple-600 font-bold text-4xl sm:text-5xl">
          ...
          <div className="hidden lg:block lg:order-2 text-center lg:text-left">
            <motion.div
              ...
              className="mb-4"
            >
              <span className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-violet-600 text-white px-5 py-2 rounded-full text-sm font-bold shadow-lg">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 inline-block">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <span className="text-purple-600 font-bold text-4xl lg:text-5xl">
            ...
            <div>
              <Button
                onClick={onBuyNow}
                size="lg"
                className="px-10 py-6 text-lg font-bold bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02]"
              >
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              {[
                ...
                <div key={idx} className="flex flex-col items-center gap-1 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-purple-100">
...
const FeaturesBanner = memo(() => (
  <section className="bg-gradient-to-r from-purple-600 via-violet-600 to-purple-600 py-5">
    <div className="container mx-auto px-4">
      <div className="flex flex-wrap justify-center gap-4 md:gap-8">
        {[
          { text: "রেয়ন কটন ফেব্রিক্স", icon: "✨" },
          { text: "এমব্রয়ডারি ওয়ার্ক", icon: "🎨" },
          { text: "সিকোয়েন্স ডিজাইন", icon: "💎" },
    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <span className="inline-block bg-purple-100 text-purple-600 px-4 py-1.5 rounded-full text-sm font-medium mb-3">
            📸 গ্যালারি
          </span>
          ...
          {products.map((product) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 text-center">{COLOR_LABEL[product.slug] || product.name}</h3>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            <span className="inline-flex items-center gap-2 bg-purple-100 text-purple-600 px-4 py-1.5 rounded-full text-sm font-medium mb-3">
              📋 বিস্তারিত
            </span>
    ...
    <section className="py-8 md:py-10 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-4">
          <span className="inline-flex items-center gap-2 bg-purple-600 text-white px-4 py-1.5 rounded-full text-sm font-medium">
...
const CheckoutSection = memo(({ products, onSubmit, isSubmitting, selectedProductId, onProductSelect, onPhoneCapture }: {
  ...
  return (
    <section id="checkout" className="py-10 md:py-14 bg-gradient-to-b from-purple-50 to-white">
      <div className="container mx-auto px-4">
        <div className="max-w-lg mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Product Selection */}
            <div id="checkout-product-selector" className={`bg-white rounded-xl shadow-lg overflow-hidden border-2 ${!form.selectedProductId ? 'border-purple-300' : 'border-transparent'}`}>
              <div className="bg-gradient-to-r from-purple-600 to-violet-600 text-white py-3 px-4 font-bold flex items-center gap-2">
              ...
              <div className="p-4">
                {!form.selectedProductId && (
                  <p className="text-sm text-purple-600 mb-3 font-medium">👇 এখান থেকে কালার সিলেক্ট করুন</p>
                )}
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-purple-500 text-white flex items-center justify-center hover:bg-purple-600 font-bold text-lg"
                  >+</button>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 border space-y-3">
              ...
              <Input
                ...
                inputMode="numeric"
                required
                className="h-12 text-base rounded-lg border-2 focus:border-purple-500"
              />
              <Input
                value={form.name}
              ...
              <div className="relative">
                ...
                <Textarea
                  ...
                  required
                  rows={2}
                  className="pl-10 text-base rounded-lg border-2 focus:border-purple-500 resize-none"
                />
              </div>
              <div className="relative">
            ...
            {/* Order Summary */}
            <div className="bg-gradient-to-r from-purple-600 to-violet-600 rounded-xl p-4 text-white">
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-purple-100">সাবটোটাল ({form.quantity}টি)</span>
                  <span>৳{subtotal.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-100">ডেলিভারি</span>
                  <span>৳{shippingCost}</span>
                </div>
                <div className="flex justify-between text-lg font-bold pt-2 border-t border-purple-400">
                  <span>সর্বমোট</span>
            ...
            <div className="text-center text-sm text-gray-600 space-y-1">
              <p>
                কল করুন: <a href="tel:+8801719725181" className="font-bold text-gray-900">01719725181</a>
              </p>
              <a
  ...
  <AnimatePresence>
    {show && (
      ...
      >
        <Button
          onClick={onClick}
          className="w-full h-14 text-base font-bold bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white rounded-xl shadow-xl"
        >
          <ShoppingBag className="mr-2 h-5 w-5" />
          এখনই অর্ডার করুন
        </Button>
...
const ReyonCottonLandingPage = () => {
  ...
  useEffect(() => {
    const checkVisibility = () => {
      if (checkoutRef.current) {
        ...
        setShowFloatingCta(rect.top > window.innerHeight * 0.7);
      }
    };
  ...
  const { data: products, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      return PRODUCT_SLUGS
        .map(slug => productsWithVariations.find(p => p.slug === slug))
  ...
  useEffect(() => {
    if (products && products.length > 0 && pixelReady && !hasTrackedViewContent.current) {
      ...
      trackViewContentWithEventId({
        ...
        content_name: 'Reyon Cotton Collection',
      ...
      serverTracking.trackViewContent({
        ...
        contentName: 'Reyon Cotton Collection',
        value: firstProduct.price,
      });
    }
  ...
  const { data: videoUrl } = useQuery({
    queryKey: ["reyon-cotton-video-url"],
    queryFn: async () => {
      const { data, error } = await supabase
        .from("admin_settings")
        .select("value")
    ...
    try {
      ...
      navigate('/order-confirmation', {
        state: {
          ...
          landingPageSlug: 'reyon-cotton-collection',
        }
      });
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <FloatingCTA show={showFloatingCta} onClick={scrollToCheckout} />
    </div>
  );
};

export default ReyonCottonLandingPage;

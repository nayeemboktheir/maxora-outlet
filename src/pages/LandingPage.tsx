            ...
            <form onSubmit={(e) => handleOrderSubmit(e, settings)} className="space-y-4">
              ...
              <div className="mt-4 text-center space-y-2">
                <p className="text-gray-600 text-sm">
                  📞 যেকোনো প্রশ্নের জন্য কল করুন: <a href="tel:+8801719725181" className="font-medium text-gray-800 hover:underline">+8801719725181</a>
                </p>
                <p className="text-green-600 text-sm">
                  ...
                  >
                    ...
                    WhatsApp এ মেসেজ করুন: +8801719725181
                  </a>
                </p>
              </div>
            </form>
